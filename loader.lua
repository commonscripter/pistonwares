...
--[[
	Step 0: the key gate. -- REMOVED: No key authentication required.
]]

-- Continue directly to injection steps without any key check.

-- Decided before the folders are created, while 'did this run create the install' is still
-- observable. The key gate above yielded, but it runs before any folder exists and its own
